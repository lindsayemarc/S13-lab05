package edu.ucsb.cs56.S13.drawings.mlindsay.simple;
...
/**
   ...
   @author Marc Lindsay (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManTopCircle =
       ...
       g2.drawString("Top of snowman added by Marc Lindsay", 20,40);
    }
